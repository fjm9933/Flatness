# -*- coding: utf-8 -*-
"""
Generate answers with local EA model (sanitized: no hardcoded paths).

Usage example:
CUDA_VISIBLE_DEVICES=0 python3 -m eagle.evaluation.gen_ea_answer_llama3chat \
  --prefix /your_path \
  --ea-model-path /your_path/output/ckp/run_metric50/state_10 \
  --base-model-path /your_path/pretrained_models/llama-3-8b-instruct \
  --bench-name gsm8k \
  --model-id ea_metric50_state10 \
  --temperature 0.0
"""
import argparse
import json
